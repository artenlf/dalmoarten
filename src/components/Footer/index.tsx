    ...
    <footer className="bg-slate-900 w-full flex flex-col gap-8 px-32 py-8">
      ...
      >
        ...
        <div className="max-w-[35rem] text-gray-100 font-bold space-y-2">
          <span>
            Rua Barão de Jaguara, 1481 - Ed. Cruz Alta - 10º andar - Cj. 102/104
            Centro, Campinas/SP
          </span>
          <p>
            CEP: <span>13015-002</span>
          </p>
          <p>
            Telefone: <span>(19) 3237-1983 / (19) 3237-1974</span>
          </p>
          <iframe
            ...
            width="600"
            height="450"
            className="border-0 max-h-48 max-w-xs"
            allowFullScreen
            loading="lazy"
      ...
      <p className="text-gray-100 text-sm mx-auto my-[-1.75rem]">
