...
export default function Hero() {
  return (
    ...
    >
      <div
        className="flex items-center justify-between py-8 px-32
         bg-slate-300 bg-opacity-60"
      >
        <div className="flex flex-col gap-8">
          <h1 className="text-4xl font-bold text-slate-900">
            Contabilidade descomplicada e tranquilidade para o seu negócio
            crescer!
          </h1>
          <span className="text-gray-600 text-justify max-w-[32.5rem] ml-2">
            Oferecemos planos de serviços especializados para simplificar a sua
            rotina e poupar tempo e dinheiro. No digital, ou no presencial,
