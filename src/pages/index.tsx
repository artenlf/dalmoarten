...
export default function Home() {
  return (
    <main
      className="bg-[url('../assets/hero/3.svg')]
    bg-cover bg-no-repeat bg-fixed"
    >
      <section
        className=" flex items-center justify-evenly 
        bg-slate-300 bg-opacity-10 h-[calc(100vh-8rem)]
      "
      >
        ...
        >
          ...
          >
            ...
            <span
              className="text-slate-200 text-justify max-w-[32.5rem] ml-2"
            >
            ...
            <button
              className="bg-slate-400 text-slate-900 font-bold py-5 w-48 rounded-full 
          hover:text-gold-700 transition ease-in-out delay-140 
         hover:-translate-1 hover:scale-110 hover:bg-slate-500 duration-200"
            >
              Saiba Mais
            </button>
          </div>
